...
module Cardano.Api.Config.TracingOrphanInstances.Consensus () where
...
import           Cardano.Api.Config.TracingOrphanInstances.Common
import           Cardano.Api.Config.TracingOrphanInstances.Network (showTip, showPoint)
