...
toLedgerPParamsDelta ShelleyBasedEraConway  = toConwayPParamsUpdate
...
toConwayPParamsUpdate :: ProtocolParametersUpdate -> Babbage.BabbagePParamsUpdate ledgerera
...
fromLedgerPParamsDelta ShelleyBasedEraConway  = fromConwayPParamsUpdate
...
fromConwayPParamsUpdate :: Babbage.BabbagePParamsUpdate ledgerera -> ProtocolParametersUpdate
...
toConwayPParams :: ProtocolParameters -> Babbage.BabbagePParams ledgerera
...
fromConwayPParams :: Babbage.BabbagePParams ledgerera -> ProtocolParameters
...
checkProtocolParameters sbe ProtocolParameters{..} =
  case sbe of
    ...
    ShelleyBasedEraConway -> checkConwayParams
 where
   era :: CardanoEra era
   ...
   checkConwayParams :: Either ProtocolParametersError ()
   checkConwayParams =
     if all (== True) conwayPParamFieldsRequirements
     then return ()
     else Left PParamsErrorMissingAlonzoProtocolParameter
