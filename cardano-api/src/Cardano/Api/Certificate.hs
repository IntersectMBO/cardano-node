...
instance EraCast Certificate where
  eraCast _ = \case
    StakeAddressRegistrationCertificate c -> pure $ StakeAddressRegistrationCertificate c
    StakeAddressDeregistrationCertificate stakeCredential -> pure $ StakeAddressDeregistrationCertificate stakeCredential
    StakeAddressPoolDelegationCertificate stakeCredential poolId -> pure $ StakeAddressPoolDelegationCertificate stakeCredential poolId
    StakePoolRegistrationCertificate stakePoolParameters -> pure $ StakePoolRegistrationCertificate stakePoolParameters
    StakePoolRetirementCertificate poolId epochNo -> pure $ StakePoolRetirementCertificate poolId epochNo
    GenesisKeyDelegationCertificate genesisKH genesisDelegateKH vrfKH -> pure $ GenesisKeyDelegationCertificate genesisKH genesisDelegateKH vrfKH
    MIRCertificate mirPot mirTarget -> pure $ MIRCertificate mirPot mirTarget
...
makeStakeAddressRegistrationCertificate :: CardanoEra era -> StakeCredential -> Certificate era
makeStakeAddressRegistrationCertificate _ = StakeAddressRegistrationCertificate

makeStakeAddressDeregistrationCertificate :: CardanoEra era -> StakeCredential -> Certificate era
makeStakeAddressDeregistrationCertificate _ = StakeAddressDeregistrationCertificate

makeStakeAddressPoolDelegationCertificate :: CardanoEra era -> StakeCredential -> PoolId -> Certificate era
makeStakeAddressPoolDelegationCertificate _ = StakeAddressPoolDelegationCertificate

makeStakePoolRegistrationCertificate :: CardanoEra era -> StakePoolParameters -> Certificate era
makeStakePoolRegistrationCertificate _ = StakePoolRegistrationCertificate

makeStakePoolRetirementCertificate :: CardanoEra era -> PoolId -> EpochNo -> Certificate era
makeStakePoolRetirementCertificate _ = StakePoolRetirementCertificate

makeGenesisKeyDelegationCertificate :: CardanoEra era
                                    -> Hash GenesisKey
                                    -> Hash GenesisDelegateKey
                                    -> Hash VrfKey
                                    -> Certificate era
makeGenesisKeyDelegationCertificate _ = GenesisKeyDelegationCertificate

makeMIRCertificate :: CardanoEra era -> MIRPot -> MIRTarget -> Certificate era
makeMIRCertificate _ = MIRCertificate
