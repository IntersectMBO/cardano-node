...
-- Generated ByetString must have at least one byte. If this is allowed to generate
-- a zero length ByteString, when round tripping the Metadata via JSON, it is not
-- possible to distinguish between 'S "0x"' and 'B ""'.
genByteString :: Gen ByteString
genByteString = BS.pack <$> Gen.list (Range.linear 1 64) Gen.latin1
