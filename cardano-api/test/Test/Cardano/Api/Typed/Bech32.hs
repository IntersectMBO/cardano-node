...
prop_roundtrip_Address_Shelley =
  roundtrip_Bech32 AsShelleyAddress genAddressShelley
...
roundtrip_Bech32
  :: (SerialiseAsBech32 a, Eq a, Show a) => AsType a -> Gen a -> Property
roundtrip_Bech32 typeProxy gen = H.property $ do
  val <- H.forAll gen
