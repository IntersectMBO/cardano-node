...
prop_golden_AllMultiSig =
  goldenTestJSONPretty exampleShelleyAll "test/Golden/MultiSig/Shelley/all"

prop_golden_AnyMultiSig :: Property
prop_golden_AnyMultiSig =
  goldenTestJSONPretty exampleShelleyAny "test/Golden/MultiSig/Shelley/any"

prop_golden_MofNMultiSig :: Property
prop_golden_MofNMultiSig =
  goldenTestJSONPretty exampleShelleyMofN "test/Golden/MultiSig/Shelley/atleast"
