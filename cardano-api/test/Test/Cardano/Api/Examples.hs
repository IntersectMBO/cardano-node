...
import           Cardano.Api.Typed (Allegra, Mary, MultiSigScript (..), ScriptFeatureInEra (..),
                     Shelley)
...
exampleShelleyAll :: MultiSigScript Shelley
exampleShelleyAll =
...
exampleShelleyAny :: MultiSigScript Shelley
exampleShelleyAny =
...
exampleShelleyMofN :: MultiSigScript Shelley
exampleShelleyMofN =
...
exampleAllegraAll :: MultiSigScript Allegra
exampleAllegraAll =
  RequireAllOf [ RequireSignature
                   (convertToHash "e09d36c79dec9bd1b3d9e152247701cd0bb860b5ebfd1de8abb6735a")
                   SignaturesInAllegraEra
               , RequireTimeBefore (SlotNo 42) TimeLocksInAllegraEra
               ]


exampleAllegraAny :: MultiSigScript Allegra
exampleAllegraAny =
  RequireAnyOf [ RequireSignature
                   (convertToHash "d92b712d1882c3b0f75b6f677e0b2cbef4fbc8b8121bb9dde324ff09")
                   SignaturesInAllegraEra
               , RequireTimeAfter (SlotNo 42) TimeLocksInAllegraEra
               ]

exampleAllegraMofN :: MultiSigScript Allegra
exampleAllegraMofN =
...
exampleMaryAll :: MultiSigScript Mary
exampleMaryAll =
  RequireAllOf [ RequireSignature
                   (convertToHash "e09d36c79dec9bd1b3d9e152247701cd0bb860b5ebfd1de8abb6735a")
                   SignaturesInMaryEra
               , RequireTimeBefore (SlotNo 42) TimeLocksInMaryEra
               ]


exampleMaryAny :: MultiSigScript Mary
exampleMaryAny =
  RequireAnyOf [ RequireSignature
                   (convertToHash "d92b712d1882c3b0f75b6f677e0b2cbef4fbc8b8121bb9dde324ff09")
                   SignaturesInMaryEra
               , RequireTimeAfter (SlotNo 42) TimeLocksInMaryEra
               ]

exampleMaryMofN :: MultiSigScript Mary
exampleMaryMofN =
  RequireMOf 1 [ RequireSignature
                   (convertToHash "2f3d4cf10d0471a1db9f2d2907de867968c27bca6272f062cd1c2413")
                   SignaturesInMaryEra
