...
import qualified Plutus.V1.Ledger.EvaluationContext as PlutusTesting
...
genCostModel = CostModel <$>
  mapM
    (const $ Gen.integral (Range.linear 0 5000))
    PlutusTesting.costModelParamsForTesting
