...
shell-cabal: ARGS += --arg 'useCabalRun' true    ## Nix shell, (workbench from Cabal), vars: PROFILE, CMD, RUN
shell-dev shell-prof shell-cabal-prof: ARGS += --arg 'useCabalRun' true --arg 'profiling' '"space"' ## Nix shell, everything Haskell built profiled
