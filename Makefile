...
##
PROFILES_BASE             := default default-p2p default-dense default-dense-1h default-dense-4h default-dense-rtsprof plutus plutus-secp-ecdsa plutus-secp-schnorr oldtracing idle tracer-only
PROFILES_BASE             += default-dense-1h-rtsprof default-dense-4h-rtsprof
