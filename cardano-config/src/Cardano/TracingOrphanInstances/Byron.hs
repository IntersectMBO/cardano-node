...
module Cardano.TracingOrphanInstances.Byron
  ()
where
...
import           Cardano.Chain.Block            ( ChainValidationError(..)
                                                , ABlockOrBoundaryHdr(..)
                                                , AHeader(..)
...
instance ToObject ApplyMempoolPayloadErr where
  toObject _verb (MempoolTxErr utxoValidationErr) = mkObject
    [ "kind" .= String "MempoolTxErr"
    , "error" .= String (show utxoValidationErr)
    ]
  toObject _verb (MempoolDlgErr delegScheduleError) = mkObject
    [ "kind" .= String "MempoolDlgErr"
    , "error" .= String (show delegScheduleError)
    ]
  toObject _verb (MempoolUpdateProposalErr iFaceErr) = mkObject
    [ "kind" .= String "MempoolUpdateProposalErr"
    , "error" .= String (show iFaceErr)
    ]
  toObject _verb (MempoolUpdateVoteErr iFaceErrr) = mkObject
...
instance ToObject UpdateState where
  toObject _verb updateState = case updateState of
    UpdateRegistered slot ->
      mkObject ["kind" .= String "UpdateRegistered", "slot" .= slot]
    UpdateActive votes -> mkObject
      [ "kind" .= String "UpdateActive"
      , "votes" .= map (Text.pack . show) (Set.toList votes)
      ]
    UpdateConfirmed slot ->
      mkObject ["kind" .= String "UpdateConfirmed", "slot" .= slot]
    UpdateStablyConfirmed endorsements -> mkObject
      [ "kind" .= String "UpdateStablyConfirmed"
      , "endorsements" .= map (Text.pack . show) (Set.toList endorsements)
      ]
    UpdateCandidate slot ->
      mkObject ["kind" .= String "UpdateCandidate", "slot" .= slot]
    UpdateStableCandidate transitionEpoch -> mkObject
...
instance ToObject ChainValidationError where
  ...
  toObject _verb ChainValidationBlockAttributesTooLarge =
    mkObject ["kind" .= String "ChainValidationBlockAttributesTooLarge"]
  toObject _verb (ChainValidationBlockTooLarge _ _) =
    mkObject ["kind" .= String "ChainValidationBlockTooLarge"]
  toObject _verb ChainValidationHeaderAttributesTooLarge =
    mkObject ["kind" .= String "ChainValidationHeaderAttributesTooLarge"]
  toObject _verb (ChainValidationHeaderTooLarge _ _) =
    mkObject ["kind" .= String "ChainValidationHeaderTooLarge"]
  toObject _verb (ChainValidationDelegationPayloadError err) =
    mkObject ["kind" .= String err]
  toObject _verb (ChainValidationInvalidDelegation _ _) =
    mkObject ["kind" .= String "ChainValidationInvalidDelegation"]
  toObject _verb (ChainValidationGenesisHashMismatch _ _) =
    mkObject ["kind" .= String "ChainValidationGenesisHashMismatch"]
  toObject _verb (ChainValidationExpectedGenesisHash _ _) =
    mkObject ["kind" .= String "ChainValidationExpectedGenesisHash"]
  toObject _verb (ChainValidationExpectedHeaderHash _ _) =
    mkObject ["kind" .= String "ChainValidationExpectedHeaderHash"]
  toObject _verb (ChainValidationInvalidHash _ _) =
    mkObject ["kind" .= String "ChainValidationInvalidHash"]
  toObject _verb (ChainValidationMissingHash _) =
    mkObject ["kind" .= String "ChainValidationMissingHash"]
  toObject _verb (ChainValidationUnexpectedGenesisHash _) =
    mkObject ["kind" .= String "ChainValidationUnexpectedGenesisHash"]
  toObject _verb (ChainValidationInvalidSignature _) =
    mkObject ["kind" .= String "ChainValidationInvalidSignature"]
  toObject _verb (ChainValidationDelegationSchedulingError _) =
    mkObject ["kind" .= String "ChainValidationDelegationSchedulingError"]
  toObject _verb (ChainValidationProtocolMagicMismatch _ _) =
    mkObject ["kind" .= String "ChainValidationProtocolMagicMismatch"]
  toObject _verb ChainValidationSignatureLight =
    mkObject ["kind" .= String "ChainValidationSignatureLight"]
  toObject _verb (ChainValidationTooManyDelegations _) =
    mkObject ["kind" .= String "ChainValidationTooManyDelegations"]
  toObject _verb (ChainValidationUpdateError _ _) =
    mkObject ["kind" .= String "ChainValidationUpdateError"]
  toObject _verb (ChainValidationUTxOValidationError _) =
    mkObject ["kind" .= String "ChainValidationUTxOValidationError"]
  toObject _verb (ChainValidationProofValidationError _) =
    mkObject ["kind" .= String "ChainValidationProofValidationError"]
  ...
  toObject _verb b =
    mkObject
      ...
      <> case byronHeaderRaw b of
           ABOBBoundaryHdr{} -> []
           ABOBBlockHdr h -> ["delegate" .= condense (headerSignerVk h)]
   where
    headerSignerVk :: AHeader ByteString -> VerificationKey
    headerSignerVk = delegateVK . delegationCertificate . headerSignature


instance ToObject ByronOtherHeaderEnvelopeError where
  toObject _verb (UnexpectedEBBInSlot slot) =
    mkObject ["kind" .= String "UnexpectedEBBInSlot", "slot" .= slot]
