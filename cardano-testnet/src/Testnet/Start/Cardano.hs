...
cardanoTestnetDefault testnetOptions shelleyOptions conf = do
  ...
  cardanoTestnet testnetOptions UserNodeConfigNotSubmitted batch conf 
...
cardanoTestnet
  ...
  genesisBatch@(GenesisBatch (shelleyGenesis, alonzoGenesis, conwayGenesis, _))
