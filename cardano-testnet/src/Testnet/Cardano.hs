...
cardanoTestnet testnetOptions H.Conf {..} = do
  ...
  -- configuration files.
  let sourceAlonzoGenesisSpecFile = base </> "cardano-cli/cardano-cli-golden/files/golden/alonzo/genesis.alonzo.spec.json"
  ...
  let sourceConwayGenesisSpecFile = base </> "cardano-cli/cardano-cli-golden/files/golden/conway/genesis.conway.spec.json"
