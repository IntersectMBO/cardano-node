  ...
  asum' [
    ...
    , UserProvidedNodeOptions
        <$> strOption ( long "node-config"
                        <> metavar "FILEPATH"
                        <> help "Path to the node's configuration file (which is generated otherwise). This option also allows to pass custom genesis files: if an era genesis file pointed to in this file (fields \"AlonzoGenesisFile\", \"ShelleyGenesisFile\", etc.) doesn't exist, it is automatically generated. So point to an existing genesis file to use your own file, or simply omit it to have it generated by cardano-testnet. See https://github.com/IntersectMBO/cardano-node/blob/master/cardano-testnet/test/cardano-testnet-test/Cardano/Testnet/Test/CommandLineExecutable.hs for an example of usage.")
    ]
  where
