...
pOnChainParams :: Parser CustomOnChainParams
pOnChainParams = fmap (fromMaybe NoCustomParams) <$> optional $
  pCustomParamsFile <|> pCustomParamsFlavour

pCustomParamsFile :: Parser CustomOnChainParams
pCustomParamsFile = CustomParamsFile <$> OA.strOption
  (  OA.long "params-file"
...
pCustomParamsFlavour :: Parser CustomOnChainParams
pCustomParamsFlavour = OA.flag' (CustomParamsFlavour FlavourMainNet)
  (  OA.long "mainnet"
