        ...
        [ T.testGroup "Ledger Events"
           ...
           -- , ignoreOnWindows "Treasury Growth" Gov.prop_check_if_treasury_is_growing
            ...
            , T.testGroup "Simple Script"
                ...
                , ignoreOnWindows "Cost Calculation Simple Reference Script" Cardano.Testnet.Test.Cli.Scripts.Simple.CostCalculation.hprop_ref_simple_script_cost_calculation
