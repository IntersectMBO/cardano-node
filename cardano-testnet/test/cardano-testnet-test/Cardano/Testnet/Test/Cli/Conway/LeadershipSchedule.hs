...
module Cardano.Testnet.Test.Cli.Conway.LeadershipSchedule
...
hprop_leadershipSchedule = H.integrationRetryWorkspace 2 "conway-leadership-schedule" $ \tempAbsBasePath' -> do
  H.note_ SYS.os
