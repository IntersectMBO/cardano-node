...
import qualified Cardano.Rpc.Proto.Api.UtxoRpc.Submit as U5c hiding (items, predicate)
import qualified Cardano.Rpc.Proto.Api.UtxoRpc.Submit as UtxoRpc hiding (items)
