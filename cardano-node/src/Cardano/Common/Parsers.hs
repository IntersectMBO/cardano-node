...
parseNodeAddress = NodeAddress <$> parseHostAddr <*> parsePort <|> ActSocks <$> parseActivatedSocket

parseActivatedSocket :: Parser SocketActivation
parseActivatedSocket = flag UseNormalSockets
                            UseActivatedSockets
                            $ long "use-activated-sockets"
