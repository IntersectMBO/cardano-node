...
txSubmissionCountersEKG tr = Tracer $ \TxSubmissionCounters{..} -> do
  ...
  traceCounter "txSubmission.txsAccepted"           tr (fromIntegral txsAccepted)
  traceCounter "txSubmission.txsRejected"           tr (fromIntegral txsRejected)
  traceCounter "txSubmission.txIdBlockingReqsSent"  tr (fromIntegral txIdBlockingReqsSent)
  traceCounter "txSubmission.txIdPipelinedReqsSent" tr (fromIntegral txIdPipelinedReqsSent)
  traceCounter "txSubmission.txIdBlockingWaitMs"    tr (fromIntegral txIdBlockingWaitMs)
  traceCounter "txSubmission.txPipelineWaitMs"      tr (fromIntegral txPipelineWaitMs)
  traceCounter "txSubmission.txSubmissionWaitMs"    tr (fromIntegral txSubmissionWaitMs)
