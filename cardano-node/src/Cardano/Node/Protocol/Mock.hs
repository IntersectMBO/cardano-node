...
mkSomeConsensusProtocolMockBFT, mkSomeConsensusProtocolMockPBFT, mkSomeConsensusProtocolMockPraos
  :: NodeMockProtocolConfiguration -> SomeConsensusProtocol
...
mkConsensusProtocolMockBFT
  ...
  -> Consensus.Protocol
       ...
       (Bft BftMockCrypto)
mkConsensusProtocolMockBFT NodeMockProtocolConfiguration { npcMockNodeId = nodeId, npcMockNumCoreNodes = numCoreNodes }
...
mkConsensusProtocolMockPBFT
  ...
  -> Consensus.Protocol
       ...
       (PBft PBftMockCrypto)
mkConsensusProtocolMockPBFT NodeMockProtocolConfiguration { npcMockNodeId = nodeId, npcMockNumCoreNodes = numCoreNodes }
...
mkConsensusProtocolMockPraos NodeMockProtocolConfiguration { npcMockNodeId = nodeId, npcMockNumCoreNodes = numCoreNodes }
  = Consensus.ProtocolMockPraos
    (NumCoreNodes numCoreNodes)
    nodeId
    PraosParams { praosSecurityParam = mockSecurityParam
