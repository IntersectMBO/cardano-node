...
import           Ouroboros.Consensus.Node (DiskPolicyArgs (..), pattern DiskSnapshotChecksum, pattern NoDiskSnapshotChecksum, NetworkP2PMode (..),
 ...
 where
  ...
  diskPolicyArgs =
    DiskPolicyArgs
      ...
      (if ncDoDiskSnapshotChecksum nc then DiskSnapshotChecksum else NoDiskSnapshotChecksum)
