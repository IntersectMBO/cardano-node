...
mkDiffusionTracersExtra  :: forall p2p .
  ...
  -> TraceConfig
  -> NetworkP2PMode p2p
  -> IO (Diffusion.ExtraTracers p2p CardanoPeerSelectionState CardanoDebugPeerSelectionState PeerTrustable (CardanoPublicRootPeers SockAddr) (CardanoPeerSelectionView SockAddr) IO)
