...
-- Diffusion
    ...
    dtDiffusionInitializationTrDoc <- documentTracer (dtDiffusionInitializationTr ::
      Logging.Trace IO (Network.DiffusionTracer Socket.SockAddr LocalAddress))
...
-- DiffusionTracersExtra P2P
    ...
    peerSelectionTrDoc <- documentTracer (peerSelectionTr ::
      Logging.Trace IO (TracePeerSelection Cardano.DebugPeerSelectionState PeerTrustable (Cardano.ExtraPeers Socket.SockAddr) Socket.SockAddr))
    ...
    debugPeerSelectionTrDoc <- documentTracer (debugPeerSelectionTr ::
      Logging.Trace IO (DebugPeerSelection Cardano.ExtraState PeerTrustable (Cardano.ExtraPeers Socket.SockAddr) Socket.SockAddr))
