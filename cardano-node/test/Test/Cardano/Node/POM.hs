...
eExpectedConfig = do
  ...
  return $ NodeConfiguration
    ...
    , ncLedgerDbConfig = LedgerDbConfiguration DefaultNumOfDiskSnapshots DefaultSnapshotInterval DefaultQueryBatchSize V2InMemory DoDiskSnapshotChecksum noDeprecatedOptions
    }
