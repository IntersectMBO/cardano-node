...
deriving stock
  instance Eq HowToConnect
deriving stock
  instance Generic HowToConnect
deriving stock
  instance Show HowToConnect
...
wellFormed TracerConfig
 ...
 where
  ...
  nullAddress (LocalPipe address)       = null address
  nullAddress (RemoteSocket host _port) = Text.null host
