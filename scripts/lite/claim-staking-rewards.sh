...
utxo_stake_addr=$(cardano-cli stake-address build --stake-verification-key-file "example/shelley/utxo-keys/utxo-stake.vkey" --testnet-magic 42)

$CARDANO_CLI query stake-address-info \
  --testnet-magic "$TESTNET_MAGIC" \
  --address "$utxo_stake_addr" \
  --out-file "$WORK/utxo1-reward.balance"
