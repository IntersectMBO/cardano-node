...
drepDeposit=$($CARDANO_CLI conway query gov-state --testnet-magic $NETWORK_MAGIC | jq -r .enactState.curPParams.dRepDeposit)
...
$CARDANO_CLI conway query drep-state --testnet-magic "$NETWORK_MAGIC"
