...
let
  ssh-service =
    ...
    let
      ...
      # TODO: Move this dependency to the repository's flake or at least don't
      # have have the flake/version twice, here and in nomad.nix.
      openssh_hacks_commit = "7b89b1b3b1bed782de5fc3d22471e1bc0ec6c506";
      openssh_hacks        = (__getFlake "github:fmaste/openssh-portable-hacks/${openssh_hacks_commit}").packages.x86_64-linux.openssh_hacks;
    ...
    in {
      ...
      config = rec {
        ...
        # - StrictModes no: This or setting a proper home for the `nobody` user
