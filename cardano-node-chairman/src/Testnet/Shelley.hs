...
testnet H.Conf {..} = do
  ...
  -- cycling KES keys
  H.rewriteJson (tempAbsPath </> "genesis.spec.json") (rewriteGenesisSpec startTime supply)
  H.rewriteJson (tempAbsPath </> "genesis.json"     ) (rewriteGenesisSpec startTime supply)
