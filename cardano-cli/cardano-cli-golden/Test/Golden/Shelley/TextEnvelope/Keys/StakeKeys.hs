...
golden_shelleyStakeKeys = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference keys
  referenceVerKey <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/verification_key"
  referenceSignKey <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/signing_key"
