...
golden_shelleyStakeAddressCertificates = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference files
  referenceRegistrationCertificate <- noteInputFile "cardano-cli-golden/files/golden/shelley/certificates/stake_address_registration_certificate"
  referenceDeregistrationCertificate <- noteInputFile "cardano-cli-golden/files/golden/shelley/certificates/stake_address_deregistration_certificate"
