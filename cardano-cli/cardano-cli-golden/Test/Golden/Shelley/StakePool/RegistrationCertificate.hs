...
golden_shelleyStakePoolRegistrationCertificate = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  operatorVerificationKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/node-pool/operator.vkey"
  vrfVerificationKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/node-pool/vrf.vkey"
  ownerVerificationKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/node-pool/owner.vkey"
