...
golden_shelleyAddressBuild = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  addressVKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/payment_keys/verification_key"
  addressSKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/verification_key"
  goldenStakingAddressHexFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/addresses/staking-address.hex"
  goldenEnterpriseAddressHexFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/addresses/enterprise-address.hex"
