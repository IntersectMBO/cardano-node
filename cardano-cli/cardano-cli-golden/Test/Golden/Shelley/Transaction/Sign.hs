...
golden_shelleyTransactionSign = propertyOnce $ H.moduleWorkspace "tmp" $ \tempDir -> do
  txBodyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/tx/txbody"
  initialUtxo1SigningKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/payment_keys/signing_key"
  utxoSigningKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/transaction-sign/utxo.skey"
  stakeSigningKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/transaction-sign/stake.skey"
  nodeColdSigningKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/transaction-sign/node-cold.skey"
