...
golden_shelleyTransactionBuild_CertificateScriptWitnessed =
  propertyOnce $ H.moduleWorkspace "tmp" $ \tempDir -> do
    let deregcert = "cardano-cli-golden/files/golden/shelley/certificates/stake_address_deregistration_certificate"
        scriptWit = "cardano-cli-golden/files/golden/shelley/multisig/scripts/any"
...
golden_shelleyTransactionBuild_Minting =
  propertyOnce $ H.moduleWorkspace "tmp" $ \tempDir -> do
    let scriptWit = "cardano-cli-golden/files/golden/shelley/multisig/scripts/any"
...
golden_shelleyTransactionBuild_WithdrawalScriptWitnessed =
  propertyOnce $ H.moduleWorkspace "tmp" $ \tempDir -> do
    ...
    stakeAddress <- H.readFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/reward_address"
