...
golden_shelleyGenesisInitialTxIn = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  verificationKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/genesis_verification_keys/genesis-utxo.vkey"
  goldenUtxoHashFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/genesis_utxo_hashes/utxo_hash"
