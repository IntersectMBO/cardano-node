...
golden_shelleyGenesisCreate = propertyOnce $ do
  H.moduleWorkspace "tmp" $ \tempDir -> do
    sourceGenesisSpecFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/genesis/genesis.spec.json"
    sourceAlonzoGenesisSpecFile <- noteInputFile "cardano-cli-golden/files/golden/alonzo/genesis.alonzo.spec.json"
    sourceConwayGenesisSpecFile <- noteInputFile "cardano-cli-golden/files/golden/conway/genesis.conway.spec.json"
