...
golden_shelleyStakeAddressBuild = propertyOnce . H.moduleWorkspace "tmp" $ \_ -> do
  verificationKeyFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/verification_key"
  goldenRewardAddressFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/keys/stake_keys/reward_address"
