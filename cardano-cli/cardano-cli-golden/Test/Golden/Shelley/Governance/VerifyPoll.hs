...
golden_shelleyGovernanceVerifyPoll = propertyOnce $ do
  pollFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/polls/basic.json"
  txFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/verify/valid"
  vkFile <- VerificationKeyFilePath . File <$>
    noteInputFile "cardano-cli-golden/files/golden/shelley/governance/cold.vk"
...
golden_shelleyGovernanceVerifyPollMismatch = propertyOnce $ do
  pollFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/polls/basic.json"
  txFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/verify/mismatch"
...
golden_shelleyGovernanceVerifyPollNoAnswer = propertyOnce $ do
  pollFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/polls/basic.json"
  txFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/verify/none"
...
golden_shelleyGovernanceVerifyPollMalformedAnswer = propertyOnce $ do
  pollFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/polls/basic.json"
  txFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/verify/malformed"
...
golden_shelleyGovernanceVerifyPollInvalidAnswer = propertyOnce $ do
  pollFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/polls/basic.json"
  txFile <- noteInputFile "cardano-cli-golden/files/golden/shelley/governance/verify/invalid"
