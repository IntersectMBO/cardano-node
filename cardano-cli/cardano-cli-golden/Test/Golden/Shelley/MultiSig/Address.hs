...
golden_shelleyAllMultiSigAddressBuild = propertyOnce . H.moduleWorkspace "tmp" $ \_ -> do
  allMultiSigFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/scripts/all"
  ...
  goldenAllMultiSigAddrFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/addresses/all"
...
golden_shelleyAnyMultiSigAddressBuild = propertyOnce . H.moduleWorkspace "tmp" $ \_ -> do
  anyMultiSigFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/scripts/any"
  ...
  goldenAnyMultiSigAddrFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/addresses/any"
...
golden_shelleyAtLeastMultiSigAddressBuild = propertyOnce . H.moduleWorkspace "tmp" $ \_ -> do
  atLeastMultiSigFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/scripts/atleast"
  ...
  goldenAtLeastMultiSigAddrFp <- noteInputFile "cardano-cli-golden/files/golden/shelley/multisig/addresses/atleast"
