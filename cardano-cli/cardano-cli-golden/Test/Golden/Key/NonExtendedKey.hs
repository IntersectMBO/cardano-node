...
golden_KeyNonExtendedKey_GenesisExtendedVerificationKey =
  propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
    genesisVKeyFp <- H.note "cardano-cli-golden/files/golden/key/non-extended-keys/shelley.000.vkey"
    nonExtendedFp <-  H.note "cardano-cli-golden/files/golden/key/non-extended-keys/non-extended-shelley.000.vkey"
...
golden_KeyNonExtendedKey_StakeExtendedVerificationKeyShelley =
  propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
    genesisVKeyFp <- H.note "cardano-cli-golden/files/golden/key/non-extended-keys/stake.000.vkey"
    nonExtendedFp <-  H.note "cardano-cli-golden/files/golden/key/non-extended-keys/non-extended-stake.000.vkey"
