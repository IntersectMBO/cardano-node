...
golden_view_byron =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    H.diffVsGoldenFile result "cardano-cli-golden/files/golden/byron/transaction-view.out"

golden_view_shelley :: Property
golden_view_shelley = let
  certDir = "cardano-cli-golden/files/golden/shelley/certificates"
  certs =
    (certDir </>) <$>
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    void $
      execCardanoCLI
        ...
        ,   "cardano-cli-golden/files/golden/shelley/keys/genesis_keys/verification_key"
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    H.diffVsGoldenFile result "cardano-cli-golden/files/golden/shelley/transaction-view.out"
...
golden_view_allegra =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    H.diffVsGoldenFile result "cardano-cli-golden/files/golden/allegra/transaction-view.out"
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    void $
      execCardanoCLI
        ...
        , "--mint-script-file", "cardano-cli-golden/files/golden/mary/scripts/mint.all"
        , "--mint-script-file", "cardano-cli-golden/files/golden/mary/scripts/mint.sig"
        , "--out-file", transactionBodyFile
        ]
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    H.diffVsGoldenFile result "cardano-cli-golden/files/golden/mary/transaction-view.out"
  ...
  propertyOnce $
    moduleWorkspace "tmp" $ \tempDir -> do
      ...
      result <-
        execCardanoCLI
          ["transaction", "view", "--tx-body-file", transactionBodyFile]
      H.diffVsGoldenFile result "cardano-cli-golden/files/golden/alonzo/transaction-view.out"

golden_view_alonzo_signed :: Property
golden_view_alonzo_signed =
  let testData = "cardano-cli-golden/files/golden/alonzo"
  in
  propertyOnce $
    moduleWorkspace "tmp" $ \tempDir -> do
      transactionBodyFile <- noteTempFile tempDir "transaction-body"
