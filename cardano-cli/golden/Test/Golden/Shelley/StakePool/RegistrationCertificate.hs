...
golden_shelleyStakePoolRegistrationCertificate = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  operatorVerificationKeyFile <- noteInputFile "golden/files/golden/shelley/node-pool/operator.vkey"
  vrfVerificationKeyFile <- noteInputFile "golden/files/golden/shelley/node-pool/vrf.vkey"
  ownerVerificationKeyFile <- noteInputFile "golden/files/golden/shelley/node-pool/owner.vkey"
