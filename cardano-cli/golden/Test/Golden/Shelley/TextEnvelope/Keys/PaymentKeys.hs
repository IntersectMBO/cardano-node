...
golden_shelleyPaymentKeys = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference keys
  referenceVerKey <- noteInputFile "golden/files/golden/shelley/keys/payment_keys/verification_key"
  referenceSignKey <- noteInputFile "golden/files/golden/shelley/keys/payment_keys/signing_key"
