...
golden_shelleyKESKeys = propertyOnce . H.moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference keys
  referenceVerKey <- noteInputFile "golden/files/golden/shelley/keys/kes_keys/verification_key"
  referenceSignKey <- noteInputFile "golden/files/golden/shelley/keys/kes_keys/signing_key"
