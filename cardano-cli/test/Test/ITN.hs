...
itnVerKey :: Text
itnVerKey =
  "ed25519_pk1demeytzdadayd4qrqeg2raadp2eceg3mrdmefxyfxx73q60hg4xsjjyzyq"

-- | Bech32 signing key
itnSignKey :: Text
itnSignKey =
  "ed25519_sk1yhnetcmla9pskrvp5z5ff2v8gkenhmluy736jd6nrxrlxcgn70zsy94f7k"
...
prop_convertITNKeys = propertyOnce $ do

        -- ITN input file paths
  let
    itnVerKeyFp = "itnVerKey.key"
  ...
  execCardanoCLIParser allFiles $ evalCardanoCLIParser
    [ "shelley"
    , "key"
    , "convert-itn-key"
...
golden_bech32Decode = propertyOnce $ do
  ...
  let expectedHumanReadPartVerificationKey = "ed25519_pk"
      expectedDataPartVerificationKey =
        "6e77922c4deb7a46d4030650a1f7ad0ab38ca23b1b7794988931bd1069f7454d"
      expectedHumanReadPartSigningKey = "ed25519_sk"
      expectedDataPartSigningKey =
        "25e795e37fe9430b0d81a0a894a98745b33beffc27a3a937531987f36113f3c5"


  -- ITN Verification key decode check
  expectedHumanReadPartVerificationKey
    === Bech32.humanReadablePartToText vHumReadPart
  expectedDataPartVerificationKey === vDataPartBase16


  -- ITN Signing key decode check
  expectedHumanReadPartSigningKey
    === Bech32.humanReadablePartToText sHumReadPart
