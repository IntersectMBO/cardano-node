...
golden_shelleyOperationalCertificate = propertyOnce $ do

    -- Reference keys
  let referenceOperationalCertificate =
        "test/Test/golden/shelley/certificates/operational_certificate"
