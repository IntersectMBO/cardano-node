...
golden_shelleyStakePoolCertificates = propertyOnce . moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference files
  referenceRegistrationCertificate <- noteInputFile "test/Test/golden/shelley/certificates/stake_pool_registration_certificate"
  referenceDeregistrationCertificate <- noteInputFile "test/Test/golden/shelley/certificates/stake_pool_deregistration_certificate"
