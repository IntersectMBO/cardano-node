...
golden_shelleyStakeAddressCertificates = propertyOnce . moduleWorkspace "tmp" $ \tempDir -> do
  -- Reference files
  referenceRegistrationCertificate <- noteInputFile "test/Test/golden/shelley/certificates/stake_address_registration_certificate"
  referenceDeregistrationCertificate <- noteInputFile "test/Test/golden/shelley/certificates/stake_address_deregistration_certificate"
