...
exampleByronSigningKey =
  "xprv1pp72a64en2vf568jywe9azlgrqe3p2jjf9gxxeejn2fex8g889x54w6emg2egkaz2rxyc560fp0hrv8y0hzpuzu27zhhhgwc8t5tvrczz2jnhhjwdnd6cdjx4dxehrsr2pr406rchwctfwrgpc9r7nmakvaegyz9"

-- | An example signing key generated by @cardano-address@ using the Icarus
-- style.
exampleIcarusSigningKey :: Text
exampleIcarusSigningKey =
  "xprv1yq7c6nlmxncg7txy0z6lqf3fww4vm20m60lrxttx5lr4qmkvh395m3p59v8fn4ku9mzycg2rkxatgwm86uc3pvrt06e43afya6rm0s2azlpnc9yrhygl2heckeyhhtgad08c0zljpnc6fse2ldzyx9c86yvddxjw"
  ...
  propertyOnce . H.moduleWorkspace "tmp" $ \_ -> do
    ebip32 <-
      liftIO . readFileTextEnvelope (AsSigningKey AsPaymentExtendedKey)
        $ File "test/data/golden/shelley/keys/converted_cardano-address_keys/shelley_payment_signing_key_bip32"
    elegacy <-
      liftIO . readFileTextEnvelope (AsSigningKey AsPaymentExtendedKey)
        $ File "test/data/golden/shelley/keys/converted_cardano-address_keys/shelley_payment_signing_key_legacy"
