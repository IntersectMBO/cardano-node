...
import           Cardano.CLI.Shelley.Util (NetworkIdError(..), displayErrorText, getNetworkId, getNetworkId')
...
data ShelleyTxCmdError
  ...
  | ShelleyTxCmdSocketEnvError !EnvLookupError
  ...
  | ShelleyTxCmdGetNetworkIdError !NetworkIdError
