...
pStakeAddress =
  ...
  where
    ...
    pStakeAddressBuild =
      StakeAddressBuild <$> pStakeVerificationKeyFile
        <*> pNetworkId
        <*> pMaybeOutputFile
...
pTransaction =
  ...
  where
    ...
    pTransactionSignWit =
      TxSignWitness <$> pTxBodyFile Input
        <*> some pWitnessFile
        <*> pOutputFile
