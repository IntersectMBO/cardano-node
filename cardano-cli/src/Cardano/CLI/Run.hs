...
import           Cardano.CLI.Byron.Run          ( ByronClientCmdError
                                                , renderByronClientCmdError
                                                , runByronClientCommand
                                                )
import           Cardano.CLI.Shelley.Commands   ( ShelleyCommand )
import           Cardano.CLI.Shelley.Run        ( ShelleyClientCmdError
...
runClientCommand (ShelleyCommand c) =
  firstExceptT ShelleyClientError $ runShelleyClientCommand c
...
renderClientCommandError (ShelleyClientError err) =
