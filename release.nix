...
let
  ...
  extraBuilds = {
    ...
    cardano-deployment = pkgs.iohkNix.cardanoLib.mkConfigHtml { inherit (pkgs.iohkNix.cardanoLib.environments) mainnet testnet shelley_testnet mainnet_candidate mainnet_candidate_2 mainnet_candidate_3; };
