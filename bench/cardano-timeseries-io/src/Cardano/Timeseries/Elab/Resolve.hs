module Cardano.Timeseries.Elab.Resolve(resolveTy, resolveBinding, resolveContext, resolveExpr') where
import           Cardano.Timeseries.Elab.Typing
import qualified Cardano.Timeseries.Elab.Typing as Ty
import           Cardano.Timeseries.Interp.Expr (Expr (..))
import qualified Cardano.Timeseries.Interp.Expr as Expr
...
resolveExpr' defs (LtBool a b) = LtBool (resolveExpr' defs a) (resolveExpr' defs b)
resolveExpr' defs (LteBool a b) = LteBool (resolveExpr' defs a) (resolveExpr' defs b)
resolveExpr' defs (GtBool a b) = GtBool (resolveExpr' defs a) (resolveExpr' defs b)
resolveExpr' defs (GteBool a b) = GteBool (resolveExpr' defs a) (resolveExpr' defs b)
