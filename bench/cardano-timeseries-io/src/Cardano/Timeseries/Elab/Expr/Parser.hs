{- HLINT ignore "Use <$>" -}
module Cardano.Timeseries.Elab.Expr.Parser(Parser, expr) where

import           Cardano.Timeseries.Domain.Identifier (Identifier (User))
import           Cardano.Timeseries.Domain.Types (Label)
import           Cardano.Timeseries.Elab.Expr
import           Cardano.Timeseries.Elab.Expr.Head (Head)
import qualified Cardano.Timeseries.Elab.Expr.Head as Head
import           Cardano.Timeseries.Interp.Expr (LabelConstraint (..))
