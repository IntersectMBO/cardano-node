...
-- | A transaction observed in a block, used for both confirmed and orphaned
-- (rolled-back) transactions.
data BlockTx = BlockTx
  { -- | The transaction ID.
    blockTxId      :: !Api.TxId
    -- | Block number where this transaction was observed.
  , blockTxBlockNo :: !Block.BlockNo
    -- | Slot number where this transaction was observed.
  , blockTxSlotNo  :: !Block.SlotNo
  }
  deriving (Show, Eq)
