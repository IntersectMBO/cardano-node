...
module Cardano.Analysis.Quick.Trace
...
-- a lazy reimagining of the strict resource record in Cardano.Logging.Resources.Types
data ResourcesLazy a
  = ResourcesLazy
      { lCentiCpu   :: a
      , lCentiGC    :: a
      , lCentiMut   :: a
...
type DataResources = ResourcesLazy Word64
...
msgCustomOptions = Aeson.defaultOptions
  { Aeson.fieldLabelModifier = tail       -- Drop the "l" prefix.
