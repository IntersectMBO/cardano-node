...
profilesNoEraEmpty = map baseNoDataset
  ...
  in [
    valueDense  & P.name "default-dense"         . V.valueCloud . P.traceForwardingOn  . P.newTracing . P.p2pOn . P.analysisSizeFull . P.analysisUnitary
  , valueDense  & P.name "default-dense-rtsprof" . V.valueCloud . P.traceForwardingOn  . P.newTracing . P.p2pOn . P.analysisSizeFull . P.analysisUnitary . P.rtsEventlogged . P.rtsHeapProf
  ]  
  ++
  ------------------------------------------------------------------------------
