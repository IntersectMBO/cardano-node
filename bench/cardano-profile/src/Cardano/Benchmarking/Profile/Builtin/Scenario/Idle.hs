...
profilesNoEraIdle =
  ...
  in [
    idle & P.name "devops" . V.timescaleDevops     . P.extraFutureOffset 10 . updateQuorum . P.traceForwardingOn . P.analysisOff
  , idle & P.name "idle"   . V.timescaleCompressed . P.extraFutureOffset  0                . P.traceForwardingOn . P.analysisStandard
