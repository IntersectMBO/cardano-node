{-# LANGUAGE CPP #-}
module Cardano.ReCon.LTL.Progress(next, terminate) where

import           Cardano.ReCon.LTL.Lang.Formula
import qualified Cardano.ReCon.LTL.Lang.Formula as F
import           Cardano.ReCon.LTL.Lang.HomogeneousFormula (HomogeneousFormula)
import qualified Cardano.ReCon.LTL.Lang.HomogeneousFormula as H
