module Cardano.ReCon.LTL.Rewrite(
  rewriteHomogeneous,
  rewriteFragment,
  rewriteIdentity
  ) where
...
import           Cardano.ReCon.LTL.Lang.Fragment (findAtoms, normaliseFragment)
import           Cardano.ReCon.LTL.Lang.HomogeneousFormula (normaliseHomogeneous)
