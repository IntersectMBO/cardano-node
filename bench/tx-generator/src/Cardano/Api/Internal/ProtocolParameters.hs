...
-- protocolParamPrices, protocolParamMaxTxExUnits, protocolParamCostModels,
...
costModelToAesonValue costModels = Aeson.Object $ KeyMap.fromList $
  map
    (\(k,v) -> case Aeson.toJSON k of
      (Aeson.String text) ->
        ( read (Text.unpack text)
