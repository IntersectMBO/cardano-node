...
{-|
Module      : MonadicGen.Cardano.Benchmarking.Wallet
...
import           MonadicGen.Cardano.TxGenerator.FundQueue as FundQueue
...
-- type alias. The sole uses are in "MonadicGen.Cardano.Benchmarking.Script.Core",
-- in 'MonadicGen.Cardano.Benchmarking.Script.Core.interpretPayMode'. The 2nd
...
-- 'MonadicGen.Cardano.Benchmarking.Script.Core.interpretPayMode'. It's only
...
-- 'MonadicGen.Cardano.Benchmarking.Script.Core.evalGenerator' to pass
-- to 'MonadicGen.Cardano.TxGenerator.Tx.sourceToStoreTransaction' and
...
-- 'MonadicGen.Cardano.Benchmarking.Script.Core.evalGenerator' for the
-- 'MonadicGen.Cardano.Benchmarking.Script.Types.Split' case.
...
-- and is only ever used by 'MonadicGen.Cardano.Bencharking.Script.Core.evalGenerator'
-- to handle several of the cases of
-- 'MonadicGen.Cardano.Benchmarking.Script.Types.Generator', though it's also
