...
{-|
Module      : MonadicGen.Cardano.TxGenerator.Types
...
import           MonadicGen.Cardano.TxGenerator.Fund (Fund)

-- convenience alias for use trhougout the API
type ShelleyGenesis       = Ledger.ShelleyGenesis StandardCrypto

-- some type aliases to keep compatibility with code in MonadicGen.Cardano.Benchmarking
