...
module  MonadicGen.Cardano.TxGenerator.PureExample
        (demo)
        where
...
import           MonadicGen.Cardano.TxGenerator.FundQueue
import           MonadicGen.Cardano.TxGenerator.Setup.SigningKey
import           MonadicGen.Cardano.TxGenerator.Tx (genTx, sourceToStoreTransaction)
import           MonadicGen.Cardano.TxGenerator.Types (TxEnvironment (..), TxGenError (..), TxGenerator)
import           MonadicGen.Cardano.TxGenerator.Utils (inputsToOutputsWithFee)
import           MonadicGen.Cardano.TxGenerator.UTxO (makeToUTxOList, mkUTxOVariant)
