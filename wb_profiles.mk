...
PROFILES_MINIATURE := ci-bench ci-bench-lmdb ci-bench-lsmt ci-bench-rtview ci-bench-notracer ci-bench-drep ci-bench-plutus ci-bench-plutus24 ci-bench-plutus-secp-ecdsa ci-bench-plutus-secp-schnorr ci-bench-plutusv3-blst ci-bench-plutusv3-ripemd ci-bench-plutusv3-ripemd-step2x 10 10-notracer 10-plutus 6-dense 6-dense-rtsprof 6-dense-1h 6-dense-1h-rtsprof 6-dense-timeseries-1h 6-dense-4h 6-dense-4h-rtsprof
